  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::AWS::GlobalAccelerator::Listener::PortRange::Value->new( %$_ );
     }
   };

package Cfn::Resource::Properties::AWS::GlobalAccelerator::Listener::PortRange::Value {
  use Moose;
