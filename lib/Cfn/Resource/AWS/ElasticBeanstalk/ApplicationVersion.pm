...
Cfn::Resource::AWS::ElasticBeanstalk::ApplicationVersion - Cfn resource for AWS::ElasticBeanstalk::ApplicationVersion

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ElasticBeanstalk::ApplicationVersion.
