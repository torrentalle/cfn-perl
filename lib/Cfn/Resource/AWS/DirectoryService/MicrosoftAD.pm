# AWS::DirectoryService::MicrosoftAD generated from spec 18.4.0
  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::AWS::DirectoryService::MicrosoftAD::VpcSettings::Value->new( %$_ );
     }
   };

package Cfn::Resource::Properties::AWS::DirectoryService::MicrosoftAD::VpcSettings::Value {
  use Moose;
...
Cfn::Resource::AWS::DirectoryService::MicrosoftAD - Cfn resource for AWS::DirectoryService::MicrosoftAD

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::DirectoryService::MicrosoftAD.
