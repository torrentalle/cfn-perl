# AWS::DMS::ReplicationInstance generated from spec 14.3.0
use Moose::Util::TypeConstraints;

coerce 'Cfn::Resource::Properties::AWS::DMS::ReplicationInstance',
  from 'HashRef',
   via { Cfn::Resource::Properties::AWS::DMS::ReplicationInstance->new( %$_ ) };

package Cfn::Resource::AWS::DMS::ReplicationInstance {
  use Moose;
  extends 'Cfn::Resource';
  has Properties => (isa => 'Cfn::Resource::Properties::AWS::DMS::ReplicationInstance', is => 'rw', coerce => 1);
  
  sub AttributeList {
    [ 'ReplicationInstancePrivateIpAddresses','ReplicationInstancePublicIpAddresses' ]
  }
...
package Cfn::Resource::Properties::AWS::DMS::ReplicationInstance {
  use Moose;
  use MooseX::StrictConstructor;
  extends 'Cfn::Resource::Properties';
  
  has AllocatedStorage => (isa => 'Cfn::Value::Integer', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
  ...
  has ReplicationInstanceClass => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, required => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
  has ReplicationInstanceIdentifier => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
...
Cfn::Resource::AWS::DMS::ReplicationInstance - Cfn resource for AWS::DMS::ReplicationInstance

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::DMS::ReplicationInstance.
