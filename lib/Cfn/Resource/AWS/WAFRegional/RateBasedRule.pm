# AWS::WAFRegional::RateBasedRule generated from spec 18.4.0
  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::AWS::WAFRegional::RateBasedRule::Predicate::Value->new( %$_ );
     }
   };

package Cfn::Resource::Properties::AWS::WAFRegional::RateBasedRule::Predicate::Value {
  use Moose;
...
Cfn::Resource::AWS::WAFRegional::RateBasedRule - Cfn resource for AWS::WAFRegional::RateBasedRule

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::WAFRegional::RateBasedRule.
