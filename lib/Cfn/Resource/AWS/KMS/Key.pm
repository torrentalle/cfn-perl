# AWS::KMS::Key generated from spec 20.1.0
...
package Cfn::Resource::Properties::AWS::KMS::Key {
  ...
  has KeyUsage => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
...
Cfn::Resource::AWS::KMS::Key - Cfn resource for AWS::KMS::Key

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::KMS::Key.
