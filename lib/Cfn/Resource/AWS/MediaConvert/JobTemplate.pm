...
Cfn::Resource::AWS::MediaConvert::JobTemplate - Cfn resource for AWS::MediaConvert::JobTemplate

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::MediaConvert::JobTemplate.
