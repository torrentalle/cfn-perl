# AWS::EC2::Volume generated from spec 14.3.0
...
package Cfn::Resource::Properties::AWS::EC2::Volume {
  ...
  has MultiAttachEnabled => (isa => 'Cfn::Value::Boolean', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
...
Cfn::Resource::AWS::EC2::Volume - Cfn resource for AWS::EC2::Volume

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::Volume.
