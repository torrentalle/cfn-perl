# AWS::Logs::LogGroup generated from spec 14.3.0
...
Cfn::Resource::AWS::Logs::LogGroup - Cfn resource for AWS::Logs::LogGroup

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::Logs::LogGroup.
