# AWS::EC2::FlowLog generated from spec 14.3.0
...
Cfn::Resource::AWS::EC2::FlowLog - Cfn resource for AWS::EC2::FlowLog

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::FlowLog.
