...
Cfn::Resource::AWS::CloudWatch::CompositeAlarm - Cfn resource for AWS::CloudWatch::CompositeAlarm

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::CloudWatch::CompositeAlarm.
