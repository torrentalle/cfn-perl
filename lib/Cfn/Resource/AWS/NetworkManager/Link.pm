...
Cfn::Resource::AWS::NetworkManager::Link - Cfn resource for AWS::NetworkManager::Link

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::NetworkManager::Link.
