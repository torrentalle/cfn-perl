# AWS::ResourceGroups::Group generated from spec 11.6.0
...
package Cfn::Resource::Properties::AWS::ResourceGroups::Group {
  ...
  has Tags => (isa => 'ArrayOfCfn::Resource::Properties::AWS::ResourceGroups::Group::Json', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
}
