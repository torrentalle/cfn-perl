# AWS::QLDB::Stream generated from spec 17.0.0
  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::AWS::QLDB::Stream::KinesisConfigurationValue->new( %$_ );
     }
   };

package Cfn::Resource::Properties::AWS::QLDB::Stream::KinesisConfigurationValue {
  use Moose;
