# AWS::Glue::DevEndpoint generated from spec 14.3.0
...
package Cfn::Resource::Properties::AWS::Glue::DevEndpoint {
  ...
  has PublicKeys => (isa => 'Cfn::Value::Array|Cfn::Value::Function|Cfn::DynamicValue', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
