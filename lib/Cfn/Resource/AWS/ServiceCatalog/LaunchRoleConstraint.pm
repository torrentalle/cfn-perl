# AWS::ServiceCatalog::LaunchRoleConstraint generated from spec 14.3.0
...
package Cfn::Resource::Properties::AWS::ServiceCatalog::LaunchRoleConstraint {
  ...
  has LocalRoleName => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
...
Cfn::Resource::AWS::ServiceCatalog::LaunchRoleConstraint - Cfn resource for AWS::ServiceCatalog::LaunchRoleConstraint

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ServiceCatalog::LaunchRoleConstraint.
