# AWS::IoT::Authorizer generated from spec 18.3.0
...
package Cfn::Resource::AWS::IoT::Authorizer {
  ...
  sub supported_regions {
    [ 'ap-east-1','ap-northeast-1','ap-northeast-2','ap-south-1','ap-southeast-1','ap-southeast-2','ca-central-1','cn-north-1','cn-northwest-1','eu-central-1','eu-west-1','eu-west-2','eu-west-3','me-south-1','sa-east-1','us-east-1','us-east-2','us-gov-west-1','us-west-1','us-west-2' ]
  }
}
  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::AWS::IoT::Authorizer::TokenSigningPublicKeysValue->new( %$_ );
     }
   };

package Cfn::Resource::Properties::AWS::IoT::Authorizer::TokenSigningPublicKeysValue {
  use Moose;
