# AWS::GlobalAccelerator::Listener generated from spec 18.4.0
  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::Object::AWS::GlobalAccelerator::Listener::PortRange->new( %$_ );
     }
   };

package Cfn::Resource::Properties::Object::AWS::GlobalAccelerator::Listener::PortRange {
  use Moose;
...
Cfn::Resource::AWS::GlobalAccelerator::Listener - Cfn resource for AWS::GlobalAccelerator::Listener

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::GlobalAccelerator::Listener.
