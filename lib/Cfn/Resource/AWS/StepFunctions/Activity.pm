  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::AWS::StepFunctions::Activity::TagsEntry::Value->new( %$_ );
     }
   };

package Cfn::Resource::Properties::AWS::StepFunctions::Activity::TagsEntry::Value {
  use Moose;
