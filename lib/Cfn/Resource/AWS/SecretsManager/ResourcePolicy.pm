...
Cfn::Resource::AWS::SecretsManager::ResourcePolicy - Cfn resource for AWS::SecretsManager::ResourcePolicy

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::SecretsManager::ResourcePolicy.
